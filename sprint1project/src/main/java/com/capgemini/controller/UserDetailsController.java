...
public class UserDetailsController {
	...
	@GetMapping("/personalinformation/{User_id}")
	...
	@GetMapping("/checkstatus/{service_req_id}")
	...
	@GetMapping("/checkqueryresponse/{Enquiry_id}")
	...
	@GetMapping("/checkprice/{service_req_id}")
